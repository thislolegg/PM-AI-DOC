...
const BLOG = {
  ...
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/logo.png', // blog favicon 配置, 默认使用 /public/logo.png，支持在线图片，如 https://img.imesong.com/favicon.png
  ...
  ...require('./conf/avatar.config'), // 网站图标配置
